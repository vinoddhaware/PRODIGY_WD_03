...
const DrawGame = ({isVisible, playAgain, setDrawGame}) => {
    if(!isVisible) return;
  return (
      ...
      '> 
        <div className='bg-[url("https://img.freepik.com/free-photo/black-brick-wall-textured-background_53876-63572.jpg?ga=GA1.1.1705782801.1730307492&semt=ais_hybrid")] h-[268px]'>
            ...
            <div className='text-xl font-bold rounded-md flex justify-between p-5'>
                 <div className={setDrawGame === true ? "" : "draw"}></div>
                 <div className='ml-10'> { setDrawGame === true ? "" : "IT'S DRAW !!!"} </div>
             </div>
            <div onClick={playAgain} className='flex flex-col justify-center items-center mt-10 mb-10 space-y-5'>
